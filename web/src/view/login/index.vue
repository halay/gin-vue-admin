<template>
  <div id="userLayout" class="w-full h-full relative">
    <div
      class="rounded-lg flex items-center justify-evenly w-full h-full md:w-screen md:h-screen md:bg-[#1d1d23] bg-white"
    >
      ...
      <div class="hidden md:block w-1/2 h-full float-right bg-[#1d1d23]">
        <img
          class="h-full"
