...
type Config struct {
	...
	CozeAccessToken string   `mapstructure:"coze-access-token" json:"coze-access-token" yaml:"coze-access-token"`
	CozeApiToken    string   `mapstructure:"coze-api-token" json:"coze-api-token" yaml:"coze-api-token"`
}
