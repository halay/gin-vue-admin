...
type ExtAiTask struct {
	global.GVA_MODEL
	CompleteAt  time.Time `json:"completeAt" form:"completeAt" gorm:"comment:完成时间;column:complete_at;size:19;"` //完成时间
	...
	Options     string    `json:"options" form:"options" gorm:"comment:任务参数;column:options;size:8192;"`         //任务参数
	...
	Result      string    `json:"result" form:"result" gorm:"comment:任务结果;column:result;size:8192;"`
