...
func (a *spr) CreateShareholderProfit(c *gin.Context) {
	...
	err = serviceShareholderProfit.CreateShareholderProfit(ctx,&info)
	if err != nil {
...
func (a *spr) DeleteShareholderProfit(c *gin.Context) {
	...
	ID := c.Query("ID")
	err := serviceShareholderProfit.DeleteShareholderProfit(ctx,ID)
	if err != nil {
...
func (a *spr) DeleteShareholderProfitByIds(c *gin.Context) {
	...
	err := serviceShareholderProfit.DeleteShareholderProfitByIds(ctx,IDs)
	if err != nil {
...
func (a *spr) UpdateShareholderProfit(c *gin.Context) {
	...
	err = serviceShareholderProfit.UpdateShareholderProfit(ctx,info)
    if err != nil {
...
func (a *spr) FindShareholderProfit(c *gin.Context) {
	...
	ID := c.Query("ID")
	respr, err := serviceShareholderProfit.GetShareholderProfit(ctx,ID)
	if err != nil {
...
func (a *spr) GetShareholderProfitList(c *gin.Context) {
	...
	list, total, err := serviceShareholderProfit.GetShareholderProfitInfoList(ctx,pageInfo)
	if err != nil {
