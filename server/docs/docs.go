    ...
    "paths": {
        ...
        "/appUsers/createAppUsers": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建appUsers表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.AppUsers"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.AppLoginResponse"
                                },
                                {
                                    "type": "object",
                                    "properties": {
        ...
        "/appUsers/sendVerificationCode": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "邮箱和验证码用途",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SendVerificationCodeRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "request.SendVerificationCodeRequest": {
            ...
            "properties": {
                ...
                "purpose": {
                    "description": "register, reset_password, change_email",
                    "type": "string"
                }
            }
        },
